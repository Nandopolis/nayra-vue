  ...
  data: () => ({
    topics: [
      {title: "Editor", lessons: [
        ...
        {name: 5, title: "Conectando componentes", video: "connection", desc: "Conectar componentes define el flujo que seguira el diagrama al ejecutarse. Para conectar dos componentes haga click en la salida de un componente y otro click en la entrada de otro componente, las conecciones siempre deben ser entre una salida y una entrada. Las entradas siempre se encuentran en el lado izquierdo de un componente y las salidas en el lado derecho."},
        {name: 6, title: "Componente Terminate", video: "terminate_component", desc: "El componente Terminate es un componente especial, al igual que el componente Presentation solo debe existir uno en cada diagrama, pero a diferencia del componente Presentation no es necesario que se haga una conección, todas las conecciónes de salida de los componentes que no esten enrutadas serán enrutadas a este componente de forma interna."},
        {name: 7, title: "Re-enrutar una connección", video: "connection_reroute", desc: "Para re-enrutar una conección haga click en la conección, en ese punto aparecerá un pin el cual podrá moverlo a su elección para modificar el camino que sigue la conección. Puede agregar varios pines a una misma conección."},
